        ...
        {jsonData.buttons.map((buttons) => (
          ...
          >
            ...
            {typeof buttons.parentButton === "object" ? (
              <div className="hidden group-focus-within/main:!flex max-[768px]:group-hover/main:!flex delay-150 " tabindex="0" >
                  ...
                  {buttons.parentButton.map((parentButton) => (
                    ...
                    >
                      ...
                      {typeof parentButton.childButtons === "object" ? (
                        <ul className="hidden group-focus-within/child:flex max-[768px]:group-hover/child:!flex  flex-col pb-2 " tabindex="0" >
